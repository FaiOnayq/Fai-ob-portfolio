...
const CallToAction = () => {
  ...
  return (
    <div className="px-4" id='contact'>
      <div className="container mx-auto my-20 max-w-[800px] rounded-lg bg-[#6d5f7a] px-6 py-10 drop-shadow-md md:px-10 lg:px-14">
        <div className="flex flex-col items-center gap-4 text-headingDarkText md:!grid md:grid-cols-5 md:place-items-center">
          ...
          >
            <span className="hidden md:block">
              Have something in mind?  <br /> Let’s start a conversation.
            </span>
            <span className="md:hidden">
              Have something in mind? Let’s start a conversation.
            </span>
          </span>
